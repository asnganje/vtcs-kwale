...
const Dashboard = () => {
    ...
    return(
        <main className="relative h-[100%] mx-[5%]">
            ...
            <div className="flex flex-col lg:flex-row justify-between h-full bg-blue-700">
                <div className="flex flex-col w-[50%]">
                    <h2 className="text-white w-[100%] text-4xl font-bold font-mono m-10">
                    Cloud-based vocational training (VT) Enrolment Management
                    System.
                    </h2>
                    <p className="text-white text-2xl w-[100% ml-10 mt-3">
                    The Gateway to Streamlined
                    VT Management.
                    From a simple trainees management, 
                    to a full virtual academic platform.
                    </p>
                    <div className="flex m-10 gap-10 w-[100%">
